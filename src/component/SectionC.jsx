        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto font-medium">
              We provide more than just cars; we provide a luxury experience
              that begins the moment you step into our dealership.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="group flex flex-col items-center text-center p-12 bg-zinc-900 border border-white/10 transition-all duration-300 hover:border-red-600/50 hover:shadow-2xl hover:shadow-red-600/10">
              ...
              <p className="text-gray-400 leading-relaxed">
                We offer the most competitive pricing in the market with
                absolute transparency on every deal.
              </p>
            </div>
            ...
            <div className="group flex flex-col items-center text-center p-12 bg-zinc-900 border border-white/10 transition-all duration-300 hover:border-red-600/50 hover:shadow-2xl hover:shadow-red-600/10">
              ...
              <p className="text-gray-400 leading-relaxed">
                Every vehicle undergoes a rigorous 150-point inspection by our
            ...
            <div className="group flex flex-col items-center text-center p-12 bg-zinc-900 border border-white/10 transition-all duration-300 hover:border-red-600/50 hover:shadow-2xl hover:shadow-red-600/10">
              ...
              <p className="text-gray-400 leading-relaxed">
                Flexible payment plans and low interest rates tailored to fit
