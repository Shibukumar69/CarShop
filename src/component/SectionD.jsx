          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-zinc-900 p-12 border-l-8 border-red-600 relative overflow-hidden">
              ...
              <p className="italic text-gray-200 text-xl mb-10 leading-relaxed font-medium">
                "The selection at Lucky Cars is unmatched. I found my dream
                sedan at a price that actually made sense. The team was
            ...
            <div className="bg-zinc-900 p-12 border-l-8 border-red-600 relative overflow-hidden">
              ...
              <p className="italic text-gray-200 text-xl mb-10 leading-relaxed font-medium">
                "Easiest financing process I've ever experienced. They worked
                with my budget and got me into a 2024 SUV within the same day.
                Highly recommended!"
              </p>
